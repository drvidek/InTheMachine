...
namespace QKit
{
    ...
    public class AlarmDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            timeRemaining.floatValue = EditorGUI.FloatField(timeRemainingRect, Mathf.Max(ClipToDecimalPlace(timeRemaining.floatValue, AlarmForPool.alarmPrecision), 0f));
            EditorGUI.LabelField(ofLabelRect, "of", style);
            timeMax.floatValue = EditorGUI.FloatField(timeMaxRect, ClipToDecimalPlace(timeMax.floatValue, AlarmForPool.alarmPrecision));
